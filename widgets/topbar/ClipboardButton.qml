...
Rectangle {
    ...
    color: (bar && bar.isClipboardOpen) ? Qt.rgba(Colors.muted.r, Colors.muted.g, Colors.muted.b, 0.6) : "transparent"
    ...
    MouseArea {
        ...
        onExited: if(bar && !bar.isClipboardOpen) parent.color = "transparent"
        onClicked: {
            if (bar) {
