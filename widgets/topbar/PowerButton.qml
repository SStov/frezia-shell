...
Rectangle {
    ...
    color: (bar && bar.isPowerOpen) ? Qt.rgba(Colors.error.r, Colors.error.g, Colors.error.b, 0.3) : "transparent"
    ...
    MouseArea {
        ...
        onExited: if(bar && !bar.isPowerOpen) parent.color = "transparent"
        onClicked: {
            if (bar) {
